 ...
 *
 * Roles live in `realm_access.roles[]` — this is a Keycloak realm-access claim,
 * typically present on the ACCESS token (not always the id token), which is why
 * we decode the access token here.
 */
